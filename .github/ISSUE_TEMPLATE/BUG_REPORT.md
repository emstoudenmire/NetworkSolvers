---
name: NetworkSolvers.jl bug report
about: Create a bug report to help us improve NetworkSolvers.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("NetworkSolvers")`:
```julia
julia> using Pkg; Pkg.status("NetworkSolvers")
[YOUR OUTPUT HERE]
```
